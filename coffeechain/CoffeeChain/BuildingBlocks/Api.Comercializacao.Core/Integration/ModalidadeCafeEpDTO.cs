...
{
    /// <summary>
    /// DTO Referente ao Cadastro de ModalidadeCafeEp
    /// </summary>
    public class ModalidadeCafeEpDTO : IntegrationEvent
    {
        /// <summary>
        ...
        public string cafeCertificacao { get; set; }
        public int tipoEquivalencia { get; set; }
        /// <summary>
        /// S(sim), N(não)
        /// </summary>
