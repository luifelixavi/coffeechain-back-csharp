...
{
    /// <summary>
    /// DTO Referente ao Cadastro de OperacaoEsDerivativoCafe
    /// </summary>
    public class OperacaoEsDerivativoCafeDTO : IntegrationEvent
    {
        /// <summary>
        ...
        public string operacaoLiquidacaoTotal {get;set; }
