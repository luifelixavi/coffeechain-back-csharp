...
namespace Cocapec.ContratoFuturo.Infra.Data.Migrations
{
    ...
    [Migration("20201116220852_Relacionamento_Autorizacao_Solicitacao")]
    partial class Relacionamento_Autorizacao_Solicitacao
    {
            ...
            modelBuilder.Entity("Cocapec.ContratoFuturo.Domain.Models.ContratoCafeSaida", b =>
                {
                    ...
                    b.Property<string>("SituacaoVinculoTermo")
                        .IsRequired()
                        .HasColumnType("varchar(1)");
