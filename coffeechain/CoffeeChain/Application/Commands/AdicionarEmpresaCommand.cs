...
{
    public class AdicionarEmpresaCommand : CommandReturnId
    {
        ...
        public AdicionarEmpresaCommand(string razaoSocial, string nomeFantasia, string cNPJEmpresa, string telefoneEmpresa, string enderecoEmpresa, string cidadeEmpresa, string ufEmpresa, string paisEmpresa, string cepEmpresa, string emailEmpresa)
        {
        ...
        public List<AdicionarArmazemCommand> Armazems { get; set; }
        ...
        public class EmpresaValidation : AbstractValidator<AdicionarEmpresaCommand>
        {
